    ...
    return html`
        ...
        <div id="cmdpalette" class="hidden">
          <div class="input-container">
            ...
            <div style="width: 10%; float: left">
              <a
                class="icon-x icon icon-2x"
                onclick="gui.cmdPallet.close();"
              ></a>
            </div>
            <div class="clear"></div>
          </div>
      ...
      <script id="dialog_upload" type="text/x-handlebars-template">
        <div id="uploaddialog">
          ...
          <span>
            By uploading data to cables, you warrant and represent that you own
            or otherwise control all of the rights to the uploaded data,
            including all the rights necessary for you to provide, post, upload,
            input or submit the data. Do not upload illegal or offensive
            material.
            <br /><br />
          </span>
      ...
      <div class="cablesCssUi" id="maincomponents" style="display: none">
        ...
        <div id="canvasicons">
          ...
          <div id="canvasIconBar" class="cbl_iconbar cbl_iconbar_hor">
            ...
            <span
              onclick="gui.rendererContextMenu(this)"
              class="item threedotcanvas"
        ...
        >
          <div id="bgpreviewButtons" class="cbl_iconbar cbl_iconbar_hor">
            ...
            >
              <span
                class="icon icon-1_25x fright iconhover icon-chevron-left"
              ></span>
            </span>
            <span
              class="item"
            ...
            <ul>
              ...
              <li class="main">
                ...
                <ul class="nav-submenu">
                  ...
                  <li
                    id="nav_patch_page"
                    class="nav-sub-submenu nav_patch_page"
                  >
                    View Patch Page
                    <span class="icon icon-chevron-right"></span>
                    <ul>
                      <li>
                        <a id="nav_viewProjectLink">Open in new window</a>
                      </li>
                      <li class="divide"></li>
                      <li>
                        <a>Open on mobile:</a>
                  ...
                  <li class="nav-sub-submenu nav_remote_viewer hidden">
                    ...
                    <ul>
                      <li>
                        <a id="nav_remoteViewerLink">Open in new window</a>
                      </li>
                      <li class="divide"></li>
                      <li>
                        <a>Open on mobile:</a>
      ...
      <script id="meta_preview" type="text/x-handlebars-template">
        <style>
          .previewcontainer { cursor: pointer; padding: 10px; border-left: 1px
          solid #000; margin-bottom: 5px; position: relative; width: 100%; }
          .previewcontainer.paused canvas { opacity: 0.25; }
          .previewcontainer.paused:before { position: absolute; content:
          "paused"; font-size: 20px; padding: 10px; color: red; z-index: 99999;
          } .activePreview { border-left: 1px solid #07f78c; } .previewcontainer
          canvas { transform: scale(1, -1); } .previewcontainer canvas {
          max-height: 200px; } .previewcontainer:hover { background-color: #000;
          }
        </style>
      ...
      <script id="op_add_dependency_lib" type="text/x-handlebars-template">
        <div
          id="addopdependency_lib_{{viewId}}"
          class="libselect addopdependency"
        >
      ...
      <script id="params_ports_head" type="text/x-handlebars-template">
        <tr>
          <td
            colspan="11"
            class="panelhead"
            data-panelselector=".opports_{{dirStr}}"
          >
        ...
        <div class="tabContentScrollContainer">
          ...
          {{#if dirs}}
            <div id="dirlist" class="dragList draggable">
              ...
              {{/each}}
              <div
                class="highlightBlock info hidden"
      ...
      <script
        id="filemanager_details_lib_audio"
        type="text/x-handlebars-template"
      >
        <div class="filemanager-detail-element">
          <div style="padding:10px;">
            ...
            {{#each keys}}
              ...
              <tr>
                <td class="keyline" style="text-align: right;">
                  ...
                  {{#if options.shiftKey}}<code class="key">SHIFT</code>
                    +
                  {{/if}}
                </td>
                <td class="keyline">
      ...
      <script id="tab_keys_markdown" type="text/x-handlebars-template">
        ...
        # Keyboard Shortcuts *[mod] is your operating system’s primary modifier
        key, on Mac OS X this is [cmd], on Windows [ctrl].*
        {{#each keys}}
          {{#if group}}
      ...
      <script id="tab_preferences" type="text/x-handlebars-template">
        ...
        >
          ...
          <div class="row"><div class="title cute-7-phone cute-5-offset"><h2>ACE
                Text Editor</h2></div></div>
      ...
      <div class="cablesCssUi">
        <a
          id="undev"
          data-info="undevLogo"
          class="icon-undev info"
          target="_blank"
          href="http://www.undev.de"
        ></a>
      </div>
  ...
  async connectedCallback() {
    ...
    CABLESUILOADER.GlobalVarTester = (function () {
      ...
      var before = function (w) {
        for (var field in w) fields[field] = true;
      };

      var after = function (w) {
        for (var field in w)
          if (!fields[field]) console.log(field + " has been added");
      };
      return {
        before: before,
        after: after,
    ...
    function incrementStartup() {
      ...
      if (loadingBarEle)
        loadingBarEle.style.width =
          (CABLESUILOADER.startup.numEvents /
            CABLESUILOADER.startup.maxEvents) *
            100 +
          "%";
    }
    ...
    function logStartup(title) {
      ...
      const timeUsed =
        Math.round(
          ((performance.now() - CABLESUILOADER.uiLoadStart) / 1000) * 100,
        ) / 100;
      ...
      if (!window.CABLES || !CABLES.platform || !CABLES.platform.isDevEnv())
        return;
      document.getElementById("loadingstatusLog").innerHTML +=
        title + " (" + timeUsed + ") <br/>";
    }

    CABLESUILOADER.noCacheUrl = function (url) {
      if (window.CABLES && CABLES.platform)
        return CABLES.platform.noCacheUrl(url);
      return url;
    };
    ...
    CABLESUILOADER.loadAll = function (cfg) {
      ...
      if (cfg && cfg.platformClass) {
        if (CABLES.hasOwnProperty(cfg.platformClass)) {
          ...
          console.error(
            "could not find class for sandbox",
            cfg.platformClass,
            "using",
            platformClass,
          );
    ...
    function waitForAce() {
      if (!CABLESUILOADER.preload.opDocsAll) {
        ...
        CABLESUILOADER.uiLoadFiles =
          performance.now() - CABLESUILOADER.uiLoadStart;
    ...
    const reqTimeout = setTimeout(() => {
      ...
      document.getElementById("loadingstatusLog").innerHTML +=
        "error: could not get response from talker api. editor not in iframe? <br/>";
    }, 1000);

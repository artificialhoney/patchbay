...
export default class GlGraph {
  ...
  constructor(splineRenderer) {
    ...
    for (let i = 0; i < this.numValues * 3; i++)
      this._points[i] = Math.random();
    ...
    this._splineRenderer.setSpline(zeroLine, [
      0,
      0,
      z,
    ...
    this._splineRenderer.setSpline(upperLimitLine, [
      0,
    ...
    this._splineRenderer.setSpline(leftLine, [
      0,
      0,
      0,
      0,
    ...
    this._splineRenderer.setSpline(rightLine, [
      this._width * this._scaleX,
      0,
      0,
      this._width * this._scaleX,
  ...
  set(value) {
    ...
    for (let i = 0; i < this._values.length; i++) {
      points.push(
        i * this._scaleX,
        this._height * this._scaleY - this._values[i] * this._scaleY,
        0,
      );

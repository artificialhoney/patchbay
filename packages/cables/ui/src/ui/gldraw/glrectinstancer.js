...
import { Geometry, Mesh, Shader, Uniform } from "@cables/cables";
...
export default class GlRectInstancer extends Events {
  ...
  constructor(cgl, options) {
    ...
    this.#bounds = {
      ...
      maxX: -GlRectInstancer.DEFAULT_BIGNUM,
      minY: GlRectInstancer.DEFAULT_BIGNUM,
      maxY: -GlRectInstancer.DEFAULT_BIGNUM,
      minZ: GlRectInstancer.DEFAULT_BIGNUM,
      maxZ: -GlRectInstancer.DEFAULT_BIGNUM,
    };

function factory() {
  ...
  $iziToast.hide = function (options, $toast, closedBy) {
    ...
    setTimeout(function () {
      ...
      setTimeout(function () {
        ...
        if (
          typeof settings.onClosed !== "undefined" &&
          typeof $iziToast.children[settings.ref] !== "undefined"
        ) {
    ...
    if (
      typeof settings.onClosing !== "undefined" &&
      typeof $iziToast.children[settings.ref] !== "undefined"
    ) {
  ...
  $iziToast.show = function (options) {
    ...
    (function () {
      if (settings.overlay) {
        if (
          document.querySelector("." + PLUGIN_NAME + "-overlay.fadeIn") !== null
        ) {
    ...
    if (
      typeof settings.onClick === "function" &&
      settings.onClick.length !== 0
    ) {
    ...
    if (
      typeof settings.onOpening === "function" &&
      settings.onOpening.length !== 0
    ) {
...
export const iziToast = typeof navigator !== "undefined" && factory();

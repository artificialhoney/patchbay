...
let uniSpecStrngth = new CGL.Uniform(
  shader,
  "f",
  "specularStrength",
  specularStrength,
      ...
      if (shader)
        for (i in cgl.tempData.phong.lights) {
          ...
          // if(cgl.tempData.phong.lights[i].changed)
          {
            ...
            if (cgl.tempData.phong.lights[i].target)
              lights[count].target.setValue(
                cgl.tempData.phong.lights[i].target,
              );

            lights[count].fallOff.setValue(
              cgl.tempData.phong.lights[i].fallOff,
            );
            ...
            lights[count].ambient.setValue(
              cgl.tempData.phong.lights[i].ambient,
            );
            lights[count].specular.setValue(
              cgl.tempData.phong.lights[i].specular,
            );
            lights[count].attenuation.setValue(
              cgl.tempData.phong.lights[i].attenuation,
            );
            lights[count].type.setValue(cgl.tempData.phong.lights[i].type);
            if (cgl.tempData.phong.lights[i].cone)
              lights[count].cone.setValue(cgl.tempData.phong.lights[i].cone);
            // if(cgl.tempData.phong.lights[i].depthMVP) lights[count].depthMVP.setValue(cgl.tempData.phong.lights[i].depthMVP);
            if (cgl.tempData.phong.lights[i].depthTex)
              lights[count].texDepthTex = cgl.tempData.phong.lights[i].depthTex;
...
var bindTextures = function () {
  ...
  if (cgl.tempData.phong && cgl.tempData.phong.lights)
    for (i in cgl.tempData.phong.lights) {
      if (cgl.tempData.phong.lights[i].shadowPass == 1.0)

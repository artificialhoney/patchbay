...
const noteValues = Array.from(Array(128).keys()).map((key) => {
...
inEvent.onChange = () => {
  ...
  if (
    event.channel === midiChannelDropdown.get() - 1 &&
    learnedNotes.length === 2
  ) {
    const [start, end] = learnedNotes;

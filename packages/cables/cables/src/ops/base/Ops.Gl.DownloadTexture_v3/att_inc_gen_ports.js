...
op.initInnerPorts = function (addedOps) {
  for (let i = 0; i < addedOps.length; i++) {
    if (addedOps[i].innerInput) {
      ...
      port_7zxlhqqf8.on("change", (a, v) => {
        innerOut_7zxlhqqf8.setRef(a);
      });
      ...
      port_c6sm5ztz4.on("change", (a, v) => {
        innerOut_c6sm5ztz4.set(a);
      });
      ...
      port_6ozewyh0e.on("change", (a, v) => {
        innerOut_6ozewyh0e.set(a);
      });

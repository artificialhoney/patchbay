const triggerAnim = op.inTriggerButton("Trigger animation"),
...
function startAnim(mode, start, end, animData) {
  ...
  document
    ...
    .animate(animData, fadeInDuration.get() * 1000).onfinish = function () {
...
function holdAnim(mode, start, end, animData) {
  ...
  document
    .getElementById(divid)
    .animate(animData, holdDuration.get() * 1000).onfinish = function () {
...
function endAnim(mode, start, end, animData) {
  ...
  document
    .getElementById(divid)
    .animate(animData, fadeOutDuration.get() * 1000).onfinish = function () {
    div.style.display = "none";

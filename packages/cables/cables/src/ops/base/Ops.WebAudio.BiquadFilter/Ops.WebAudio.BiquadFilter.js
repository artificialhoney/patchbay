...
var audioInPort = CABLES.WEBAUDIO.createAudioInPort(
  op,
  "Audio In",
  biquadFilter,
);
var audioOutPort = CABLES.WEBAUDIO.createAudioOutPort(
  op,
  "Audio Out",
  biquadFilter,
);

var type = op.inValueSelect(
  "type",
  [
    "allpass",
    "lowpass",
...
var updateDetune = function () {
  biquadFilter.detune.setValueAtTime(
    detune.get(),
    window.audioContext.currentTime,
  );
};

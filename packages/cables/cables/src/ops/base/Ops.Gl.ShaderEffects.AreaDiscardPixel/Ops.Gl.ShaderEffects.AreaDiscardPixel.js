...
function updateArea() {
  ...
  shader.toggleDefine(
    moduleVert.prefix + "AREA_AXIS_XY",
    inArea.get() == "Axis XY",
  );
  shader.toggleDefine(
    moduleVert.prefix + "AREA_AXIS_XZ",
    inArea.get() == "Axis XZ",
  );
  shader.toggleDefine(
    moduleVert.prefix + "AREA_AXIS_YZ",
    inArea.get() == "Axis YZ",
  );
  shader.toggleDefine(
...
op.render.onTriggered = function () {
  ...
  if (cgl.getShader() != shader) {
    ...
    op.uniformSizeXYZ = new CGL.Uniform(
      shader,
      "3f",
      moduleFrag.prefix + "sizeAxis",
      inSizeX,
      inSizeY,
      inSizeZ,
    );
    inRepeatDist.uniform = new CGL.Uniform(
      shader,
      "f",
      moduleFrag.prefix + "repeat",
      inRepeatDist,
    );

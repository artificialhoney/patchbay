...
let elProjection = cgl.canvas.parentElement.querySelector(
  '[data-provide="css3d"]',
);
if (!elProjection) {
...
trigger.onTriggered = function () {
  let pxfov =
    ((0.5 / (1 / cgl.pMatrix[5])) * cgl.gl.drawingBufferHeight) /
    op.patch.cgl.pixelDensity;
  ...
  if (el) {
    ...
    if (el.parentElement)
      el.parentElement.style.transform =
        ...
        cgl.gl.drawingBufferWidth / 2 / op.patch.cgl.pixelDensity +
        "px," +
        cgl.gl.drawingBufferHeight / 2 / op.patch.cgl.pixelDensity +
        "px" +
        ",0" +
        ")";
  }

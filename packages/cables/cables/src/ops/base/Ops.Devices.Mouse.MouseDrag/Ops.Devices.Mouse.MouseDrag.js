...
inputType.onChange = area.onChange = updateArea;
...
function onMouseDown(e) {
  try {
    listenerElement.setPointerCapture(e.pointerId);
  } catch (_e) {}
...
function onMouseUp(e) {
  try {
    listenerElement.releasePointerCapture(e.pointerId);
  } catch (e) {}

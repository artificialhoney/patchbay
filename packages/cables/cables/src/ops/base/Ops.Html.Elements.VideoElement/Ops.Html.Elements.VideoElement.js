...
loop.onChange = controls.onChange = inMuted.onChange = updateVideoSettings;
...
function addElement() {
  ...
  element.onerror = function () {
    ...
    if (element && element.error) {
      ...
      op.log(
        "Error " + element.error.code + "; details: " + element.error.message,
      );
    }
  };

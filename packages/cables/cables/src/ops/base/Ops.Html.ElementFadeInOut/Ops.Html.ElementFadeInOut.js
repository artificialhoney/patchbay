...
inDuration.onChange = inOpacity.onChange = update;

inVisible.onChange = inEle.onChange = updateVisibility;
...
function getCssContent() {
  ...
  while (css.indexOf("$CLASSES_ID") > -1)
    css = css.replace("$CLASSES_ID", cssClassesId);

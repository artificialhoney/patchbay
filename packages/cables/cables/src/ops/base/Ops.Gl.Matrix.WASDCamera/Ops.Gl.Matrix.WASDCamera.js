...
function calcCameraMovement() {
  ...
  if (pressedW) {
    ...
    camMovementXComponent +=
      movementSpeedFactor * Math.sin(DEG2RAD * rotY.get()) * pitchFactor;

    // Control Y-Axis movement
    camMovementYComponent +=
      movementSpeedFactor * Math.sin(DEG2RAD * rotX.get()) * -1.0;

    // Control Z-Axis movement
    yawFactor = Math.cos(DEG2RAD * rotX.get());
    camMovementZComponent +=
      movementSpeedFactor * Math.cos(DEG2RAD * rotY.get()) * -1.0 * yawFactor;
  }
  ...
  if (pressedS) {
    ...
    pitchFactor = Math.cos(DEG2RAD * rotX.get());
    camMovementXComponent +=
      movementSpeedFactor * Math.sin(DEG2RAD * rotY.get()) * -1.0 * pitchFactor;

    // Control Y-Axis movement
    camMovementYComponent +=
      movementSpeedFactor * Math.sin(DEG2RAD * rotX.get());

    // Control Z-Axis movement
    yawFactor = Math.cos(DEG2RAD * rotX.get());
    camMovementZComponent +=
      movementSpeedFactor * Math.cos(DEG2RAD * rotY.get()) * yawFactor;
  }

...
const inTextureSize = op.inSwitch(
  "Texture Size",
...
shaderDefault.setSource(
  shaderDefault.getDefaultVertexShader(),
  attachments.default_frag,
);
...
shaderMirror.setSource(
  shaderMirror.getDefaultVertexShader(),
  attachments.mirror_frag,
);

const textureUniformMirror = new CGL.Uniform(shaderMirror, "t", "tex", 0);
const uniWidthMirror = new CGL.Uniform(
  shaderMirror,
  "f",
  "width",
  inMirrorWidth,

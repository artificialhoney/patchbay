...
inGeom.onChange = function () {
  ...
  if (geom.isIndexed()) {
    for (i = 0; i < geom.verticesIndices.length; i += 3) {
      ...
      verts.push(
        geom.vertices[index * 3 + 0],
        geom.vertices[index * 3 + 1],
        geom.vertices[index * 3 + 2],
      );
      verts.push(
        geom.vertices[index1 * 3 + 0],
        geom.vertices[index1 * 3 + 1],
        geom.vertices[index1 * 3 + 2],
      );
      verts.push(
        geom.vertices[index1 * 3 + 0],
        geom.vertices[index1 * 3 + 1],
      ...
      verts.push(
        geom.vertices[index2 * 3 + 0],
        geom.vertices[index2 * 3 + 1],
        geom.vertices[index2 * 3 + 2],
      );
      verts.push(
        geom.vertices[index2 * 3 + 0],
        geom.vertices[index2 * 3 + 1],
      ...
      normals.push(
        geom.vertexNormals[index * 3 + 0],
        geom.vertexNormals[index * 3 + 1],
        geom.vertexNormals[index * 3 + 2],
      );
      normals.push(
        geom.vertexNormals[index1 * 3 + 0],
        geom.vertexNormals[index1 * 3 + 1],
        geom.vertexNormals[index1 * 3 + 2],
      );
      normals.push(
        geom.vertexNormals[index1 * 3 + 0],
        geom.vertexNormals[index1 * 3 + 1],
      ...
      normals.push(
        geom.vertexNormals[index2 * 3 + 0],
        geom.vertexNormals[index2 * 3 + 1],
        geom.vertexNormals[index2 * 3 + 2],
      );
      normals.push(
        geom.vertexNormals[index2 * 3 + 0],
        geom.vertexNormals[index2 * 3 + 1],

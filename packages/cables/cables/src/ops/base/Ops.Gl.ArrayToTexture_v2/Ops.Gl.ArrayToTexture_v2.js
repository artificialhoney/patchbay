const inExe = op.inTrigger("Update"),
  ...
  inSizeType = op.inSwitch(
    "Size",
    ["Manual", "Square", "Row", "Column"],
    "Manual",
  ),
...
flip.onChange =
  ...
  inHeight.onChange =
    () => {
      ...
      else if (tfilter.get() == "Anisotropic")
        cgl_filter = CGL.Texture.FILTER_ANISOTROPIC;

      if (wrap.get() == "repeat") cgl_wrap = CGL.Texture.WRAP_REPEAT;
      else if (wrap.get() == "mirrored repeat")

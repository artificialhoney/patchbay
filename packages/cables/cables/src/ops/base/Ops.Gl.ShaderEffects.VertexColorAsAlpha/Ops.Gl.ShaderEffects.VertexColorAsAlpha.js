...
const srcHeadVert =
  "".endl() + "IN vec3 attrVertColor;".endl() + "OUT vec4 vertColor;".endl();

const srcBodyVert = "".endl() + "vertColor.rgb=attrVertColor;".endl();

inInput.onChange = inInvert.onChange = updateDefines;

const outUI = op.outBoolNum("UI", op.patch.isEditorMode()),
  outOverlay = op.outBoolNum("Overlay Mode", false),
  outRemoteViewer = op.outBoolNum(
    "Remote Viewer",
    window.gui ? window.gui.isRemoteClient : false,
  ),
  outStandalone = op.outBoolNum(
    "Is Standalone",
    CABLES.platform && CABLES.platform.frontendOptions.isElectron,
  ),

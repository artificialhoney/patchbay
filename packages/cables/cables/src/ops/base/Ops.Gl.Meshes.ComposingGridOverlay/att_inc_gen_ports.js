...
op.initInnerPorts = function (addedOps) {
  for (let i = 0; i < addedOps.length; i++) {
    if (addedOps[i].innerInput) {
      ...
      port_d19uw4ogh.onTriggered = () => {
        innerOut_d19uw4ogh.trigger();
      };
      ...
      port_m8bjeyajy.on("change", (a, v) => {
        innerOut_m8bjeyajy.set(a);
      });
      ...
      port_3yfne154r.on("change", (a, v) => {
        innerOut_3yfne154r.set(a);
      });
    }

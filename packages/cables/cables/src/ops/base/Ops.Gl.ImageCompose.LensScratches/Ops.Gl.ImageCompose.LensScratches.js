...
shader.setSource(
  ...
  attachments.lensScratches_frag,
);
...
const textureUniform = new CGL.Uniform(shader, "t", "tex", 0),
  ...
  antiAliasIterationsUniform = new CGL.Uniform(
    shader,
    "f",
    "uAntiAliasIterations",
    antiAliasIterations,
  ),
  frequencyUniform = new CGL.Uniform(shader, "f", "uFrequency", frequency),
  frequencyStepUniform = new CGL.Uniform(
    shader,
    "f",
    "uFrequencyStep",
    frequencyStep,

const isMobile = op.outBoolNum("Is Mobile", false),
...
op.setPortGroup("Operating Systems", [
  isWindows,
  isLinux,
  isMac,
  isIos,
...
op.setPortGroup("Textual Information", [
  outOS,
  outBrowserName,
  outNav,
  outVersion,
...
const isMobileBool =
  osFamily === "webOS" || // LG mobile phones

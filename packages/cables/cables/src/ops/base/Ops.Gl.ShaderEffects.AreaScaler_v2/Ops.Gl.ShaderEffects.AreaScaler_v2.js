...
const srcBodyVert =
  "".endl() +
  "pos=MOD_scaler(pos,mMatrix*pos,attrVertNormal,mMatrix);" // modelMatrix*
    .endl();
...
function updateToZero() {
  ...
  shader.toggleDefine(
    moduleVert.prefix + "OBJECT_POS",
    inSrc.get() == "Object position",
  );
...
exec.onTriggered = function () {
  ...
  if (cgl.getShader() != shader) {
    ...
    inClampMin.uniform = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "clampMin",
      inClampMin,
    );
    inClampMax.uniform = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "clampMax",
      inClampMax,
    );
  }

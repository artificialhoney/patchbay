const inForm = op.inValueSelect("Formula", [1, 2, 3], 1),
...
function calc() {
  ...
  for (var i = 0; i < numPoints; i += step) {
    ...
    if (form == 1) {
      ...
      x =
        (Math.cos(i * inA.get() * 0.001) + Math.cos(i * inB.get() * 0.001)) / 2;
      y =
        (Math.sin(i * inA.get() * 0.001) + Math.sin(i * inC.get() * 0.001)) / 2;
      z = Math.sin(i * inD.get() * 0.001);
    } else if (form == 3) {
      x =
        (Math.sin(i * inA.get() * 0.001) *
          (1 + Math.cos(i * inB.get() * 0.001))) /
        2;
      y =
        (Math.sin(i * inA.get() * 0.001) *
          (1 + Math.sin(i * inC.get() * 0.001))) /
        2;
      z = Math.sin(i * inD.get() * 0.001);
    }

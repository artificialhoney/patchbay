...
render.onTriggered = function () {
  ...
  cgl.tempData.SplinePoints[cgl.tempData.SplinePointCounter + 0] =
    vp[2] - (vp[2] * 0.5 - (trans[0] * vp[2] * 0.5) / trans[2]);
  cgl.tempData.SplinePoints[cgl.tempData.SplinePointCounter + 1] =
    vp[3] - (vp[3] * 0.5 + (trans[1] * vp[3] * 0.5) / trans[2]);

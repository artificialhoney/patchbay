...
inWidth.onChange = tfilter.onChange = twrap.onChange = initFbLater;
...
inRandomize.onChange = inGeom.onChange = function () {
...
exec.onTriggered = function () {
  ...
  if (inGeom.get()) {
    ...
    mat4.ortho(cgl.pMatrix, 0, inWidth.get(), 0, inWidth.get(), -1.0, 100);

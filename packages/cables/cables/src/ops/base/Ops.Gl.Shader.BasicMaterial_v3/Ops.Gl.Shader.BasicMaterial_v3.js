...
shader.setSource(
  attachments.basicmaterial_vert,
  attachments.basicmaterial_frag,
);
...
op.setPortGroup("Color Texture", [
  diffuseTexture,
  vertexColors,
  colorizeTexture,
]);
op.setPortGroup("Opacity", [
  textureOpacity,
  alphaMaskSource,
  discardTransPxl,
  texCoordAlpha,
...
function doRender() {
  ...
  if (diffuseTextureUniform && diffuseTexture.get())
    shader.pushTexture(diffuseTextureUniform, diffuseTexture.get());

...
function update() {
  ...
  if (ele && ele.style) {
    ...
    if (
      ...
      if (borderTop.get())
        ele.style.borderTop = inThick.get() + "px solid " + rgbaText;
      if (borderBottom.get())
        ele.style.borderBottom = inThick.get() + "px solid " + rgbaText;
      if (borderLeft.get())
        ele.style.borderLeft = inThick.get() + "px solid " + rgbaText;
      if (borderRight.get())
        ele.style.borderRight = inThick.get() + "px solid " + rgbaText;
    }

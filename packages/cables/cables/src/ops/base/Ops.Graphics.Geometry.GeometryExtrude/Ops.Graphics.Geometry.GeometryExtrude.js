const inGeom = op.inObject("Geometry", null, "geometry"),
      ...
      if (inExtrudeWalls.get())
        for (let i = 0; i < geom.verticesIndices.length; i += 3) {
          ...
          if (!edgesUsedMulti(vert1, vert2)) {
            const a = [];
            a.push([
              geom.vertices[vert1 * 3 + 0],
              geom.vertices[vert1 * 3 + 1],
              geom.vertices[vert1 * 3 + 2],
            ]);
            a.push([
              geom.vertices[vert1 * 3 + 0],
              geom.vertices[vert1 * 3 + 1],
              geom.vertices[vert1 * 3 + 2] + h,
            ]);
            a.push([
              geom.vertices[vert2 * 3 + 0],
              geom.vertices[vert2 * 3 + 1],
              geom.vertices[vert2 * 3 + 2],
            ]);
          ...
          if (!edgesUsedMulti(vert3, vert2)) {
            const a = [];
            a.push([
              geom.vertices[vert3 * 3 + 0],
              geom.vertices[vert3 * 3 + 1],
              geom.vertices[vert3 * 3 + 2],
            ]);
            a.push([
              geom.vertices[vert3 * 3 + 0],
              geom.vertices[vert3 * 3 + 1],
              geom.vertices[vert3 * 3 + 2] + h,
            ]);
            a.push([
              geom.vertices[vert2 * 3 + 0],
              geom.vertices[vert2 * 3 + 1],

...
const HELPER_FUNCS = {
  Sphere: () => {
    return CABLES.GL_MARKER.drawSphere(op, inSize.get());
  },
  Box: () => {
    return CABLES.GL_MARKER.drawCube(
      op,
      inSize.get(),
      inSize.get(),
      inSize.get(),
  ...
  "Axis X": () => {
    return CABLES.GL_MARKER.drawCube(op, inSize.get(), 2, 2);
  },
  "Axis Y": () => {
    return CABLES.GL_MARKER.drawCube(op, 2, inSize.get(), 2);
  },
  "Axis Z": () => {
    return CABLES.GL_MARKER.drawCube(op, 2, 2, inSize.get());
  },
  "Axis X Infinite": () => {
    return CABLES.GL_MARKER.drawCube(op, inSize.get(), 2, 2);
  },

const inCoords = op.inSwitch(
  ...
  area = op.inValueSelect(
    "Area",
    ["Canvas Area", "Canvas", "Document", "Parent Element"],
    "Canvas Area",
  ),
...
inPassive.onChange = area.onChange = addListeners;
...
inEle.onChange = inEventType.onChange = function () {
...
function addListeners() {
  ...
  if (inEle.isLinked()) {
    ...
    if (area.get() == "Parent Element")
      listenerElement = areaElement = cgl.canvas.parentElement;
  }

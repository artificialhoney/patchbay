...
shaderWave.setSource(
  shaderWave.getDefaultVertexShader(),
  attachments.histogram_wave_frag,
);
...
shaderPointsLumi.setSource(
  attachments.histogram_vert,
  attachments.histogram_frag,
);
shaderPointsLumi.textureUniform = new CGL.Uniform(
  shaderPointsLumi,
  "t",
  "tex",
  0,

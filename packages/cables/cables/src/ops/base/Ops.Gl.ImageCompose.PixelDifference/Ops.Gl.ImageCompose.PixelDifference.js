const options = [
  "Vertical Difference Red",
  "Vertical Difference Green",
  "Vertical Difference Blue",
  "Vertical Average Red",
  "Vertical Average Green",
  "Vertical Average Blue",
  "Vertical Luminance",
  "Horizontal Difference Red",
  "Horizontal Difference Green",
  "Horizontal Difference Blue",
  "Horizontal Average Red",
  "Horizontal Average Green",
  "Horizontal Average Blue",
...
function updateDefines() {
  shader.toggleDefine(
    "DIR_R_HORIZONTAL",
    (rMeth.get() + "").indexOf("Horizontal") != -1,
  );
  shader.toggleDefine(
    "DIR_G_HORIZONTAL",
    (gMeth.get() + "").indexOf("Horizontal") != -1,
  );
  shader.toggleDefine(
    "DIR_B_HORIZONTAL",
    (bMeth.get() + "").indexOf("Horizontal") != -1,
  );

  shader.toggleDefine(
    "METH_R_DIFF",
    (rMeth.get() + "").indexOf("Difference") != -1,
  );
  shader.toggleDefine(
    "METH_G_DIFF",
    (gMeth.get() + "").indexOf("Difference") != -1,
  );
  shader.toggleDefine(
    "METH_B_DIFF",
    (bMeth.get() + "").indexOf("Difference") != -1,
  );

  shader.toggleDefine(
    "METH_R_AVG",
    (rMeth.get() + "").indexOf("Average") != -1,
  );
  shader.toggleDefine(
    "METH_G_AVG",
    (gMeth.get() + "").indexOf("Average") != -1,
  );
  shader.toggleDefine(
    "METH_B_AVG",
    (bMeth.get() + "").indexOf("Average") != -1,
  );
  ...
  shader.toggleDefine(
    "METH_R_LUMI",
    (rMeth.get() + "").indexOf("Luminance") != -1,
  );
  shader.toggleDefine(
    "METH_G_LUMI",
    (gMeth.get() + "").indexOf("Luminance") != -1,
  );
  shader.toggleDefine(
    "METH_B_LUMI",
    (bMeth.get() + "").indexOf("Luminance") != -1,
  );

  shader.toggleDefine(
    "METH_R_MID",
    (rMeth.get() + "").indexOf("Midpoint") != -1,
  );
  shader.toggleDefine(
    "METH_G_MID",
    (gMeth.get() + "").indexOf("Midpoint") != -1,
  );
  shader.toggleDefine(
    "METH_B_MID",
    (bMeth.get() + "").indexOf("Midpoint") != -1,
  );

...
const outGlVersionShort = op.outNumber(
    "WebGl Version Short",
    op.patch.cgl.glVersion,
  ),
  outGlVersion = op.outString("WebGl Version", gl.getParameter(gl.VERSION)),
  outGlslVersion = op.outString(
    "GLSL Version",
    gl.getParameter(gl.SHADING_LANGUAGE_VERSION),
  ),
  outFragUnis = op.outNumber(
    "Max Frag uniforms",
    gl.getParameter(gl.MAX_FRAGMENT_UNIFORM_VECTORS),
  ),
  outVertUnis = op.outNumber(
    "Max Vert uniforms",
    gl.getParameter(gl.MAX_VERTEX_UNIFORM_VECTORS),
  ),
  outTexSize = op.outNumber(
    "Max Texture Size",
    gl.getParameter(gl.MAX_TEXTURE_SIZE),
  ),
  outTexUnits = op.outNumber(
    "Max Texture Units",
    gl.getParameter(gl.MAX_TEXTURE_IMAGE_UNITS),
  ),
  outVarVec = op.outNumber(
    "Max Varying Vectors",

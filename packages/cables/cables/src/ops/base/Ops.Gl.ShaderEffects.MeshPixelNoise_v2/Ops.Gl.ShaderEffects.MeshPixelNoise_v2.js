...
inBlend.onChange = inWorldSpace.onChange = updateDefines;

const srcHeadVert = "".endl() + "OUT vec4 MOD_pos;".endl();

const srcBodyVert =
  "".endl() +
  "#ifndef MOD_WORLDSPACE".endl() +
  "   MOD_pos=vec4(pos.xyz,1.0);".endl() +
  "#endif".endl() +
  "#ifdef MOD_WORLDSPACE".endl() +
  "   MOD_pos=vec4(pos.xyz,1.0)*mMatrix;".endl() +
  "#endif".endl();
...
const srcBodyFrag =
  "".endl() +
  "vec3 MOD_rndVal = vec3(1.-MOD_r,1.-MOD_g,1.-MOD_b)*MOD_meshPixelNoise(MOD_pos.xyz*MOD_scale)*MOD_amount/4.0;".endl() +
  "#ifdef MOD_BLEND_MUL".endl() +
  "   col.rgb *= MOD_rndVal;".endl() +
  "#endif".endl() +
  "#ifdef MOD_BLEND_SUB".endl() +
  "   col.rgb -= MOD_rndVal;".endl() +
  "#endif".endl() +
  "#ifdef MOD_BLEND_ADD".endl() +
  "   col.rgb += MOD_rndVal;".endl() +
  "#endif".endl();

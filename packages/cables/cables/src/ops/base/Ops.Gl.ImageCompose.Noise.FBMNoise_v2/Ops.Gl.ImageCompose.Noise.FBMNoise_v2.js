...
const textureUniform = new CGL.Uniform(shader, "t", "tex", 0),
  ...
  uniScrollX = new CGL.Uniform(
    shader,
    "f",
    "scrollX",
    op.inValue("scrollX", 9),
  ),
  uniScrollY = new CGL.Uniform(
    shader,
    "f",
    "scrollY",
  ...
  uniLayer1 = new CGL.Uniform(
    shader,
    "b",
    "layer1",
    op.inValueBool("Layer 1", true),
  ),
  uniLayer2 = new CGL.Uniform(
    shader,
    "b",
    "layer2",
    op.inValueBool("Layer 2", true),
  ),
  uniLayer3 = new CGL.Uniform(
    shader,
    "b",
    "layer3",
    op.inValueBool("Layer 3", true),
  ),
  uniLayer4 = new CGL.Uniform(
    shader,
    "b",
    "layer4",

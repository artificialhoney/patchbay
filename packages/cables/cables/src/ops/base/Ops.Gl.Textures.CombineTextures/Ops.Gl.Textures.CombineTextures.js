  ...
  if (inSize.get() == "Biggest" || inSize.get() == "Smallest") {
    if (inTexR.get())
      sizes.push([
        inTexR.get().width,
        inTexR.get().height,
        inTexR.get().width * inTexR.get().height,
      ]);
    if (inTexG.get())
      sizes.push([
        inTexG.get().width,
        inTexG.get().height,
        inTexG.get().width * inTexG.get().height,
      ]);
    if (inTexB.get())
      sizes.push([
        inTexB.get().width,
        inTexB.get().height,
        inTexB.get().width * inTexB.get().height,
      ]);
    if (inTexA.get())
      sizes.push([
        inTexA.get().width,
        inTexA.get().height,
        inTexA.get().width * inTexA.get().height,
      ]);
  }

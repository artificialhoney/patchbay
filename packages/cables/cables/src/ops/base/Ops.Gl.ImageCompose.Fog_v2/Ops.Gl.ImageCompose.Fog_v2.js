...

{
  // fog color
  let r = op.addInPort(
    new CABLES.Port(op, "fog r", CABLES.OP_PORT_TYPE_VALUE, {
      display: "range",
      colorPick: "true",
    }),
  );
  let g = op.addInPort(
    new CABLES.Port(op, "fog g", CABLES.OP_PORT_TYPE_VALUE, {
      display: "range",
    }),
  );
  let b = op.addInPort(
    new CABLES.Port(op, "fog b", CABLES.OP_PORT_TYPE_VALUE, {
      display: "range",
    }),
  );
  let a = op.addInPort(
    new CABLES.Port(op, "fog a", CABLES.OP_PORT_TYPE_VALUE, {
      display: "range",
    }),
  );

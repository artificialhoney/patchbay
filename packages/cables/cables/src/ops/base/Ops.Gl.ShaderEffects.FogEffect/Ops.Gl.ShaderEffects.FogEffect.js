...
const srcHeadVert = "".endl() + "OUT vec4 MOD_fogPos;".endl();

const srcBodyVert = "".endl() + "MOD_fogPos=viewMatrix*mMatrix*pos;".endl();

const srcHeadFrag = "".endl() + "IN vec4 MOD_fogPos;".endl();

const srcBodyFrag =
  "".endl() +
  "   float MOD_de=(MOD_fogPos.z+MOD_start)/(-1.0*MOD_end);".endl() +
  "   float mx=clamp(MOD_de*MOD_amount,0.0,1.0);"
    // .endl() + "       mx=1.0-mx;"

    .endl() +
  "#ifdef MOD_FOGMODE_ALPHA".endl() +
  "       col.a*=mix(col.a,MOD_color.r,mx);".endl() +
  "#endif".endl() +
  "#ifndef MOD_FOGMODE_ALPHA".endl() +
  "       col.rgb=mix(col.rgb,vec3(MOD_color.r,MOD_color.g,MOD_color.b), mx);".endl() +
  "#endif"

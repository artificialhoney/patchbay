const render = op.inTrigger("render"),
  ...
  output = op.inValueSelect(
    "Output",
    ["Mul Normal", "Add XYZ", "Add X", "Add Y", "Add Z"],
    "Add XYZ",
  ),
  x = op.inValueFloat("x"),
  y = op.inValueFloat("y"),
...
function updateOutput() {
  ...
  shader.toggleDefine(
    moduleVert.prefix + "METH_ADD_XYZ",
    output.get() == "Add XYZ",
  );
  shader.toggleDefine(
    moduleVert.prefix + "METH_ADD_Z",
    output.get() == "Add Z",
  );
  shader.toggleDefine(
    moduleVert.prefix + "METH_ADD_Y",
    output.get() == "Add Y",
  );
  shader.toggleDefine(
    moduleVert.prefix + "METH_ADD_X",
    output.get() == "Add X",
  );
  shader.toggleDefine(
    moduleVert.prefix + "METH_MULNORM",
    output.get() == "Mul Normal",
  );
}

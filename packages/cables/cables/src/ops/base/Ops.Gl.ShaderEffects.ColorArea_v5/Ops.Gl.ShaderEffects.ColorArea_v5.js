const render = op.inTrigger("Render"),
  ...
  inFalloffCurve = op.inSwitch(
    "Falloff Curve",
    ["Linear", "Smoothstep", "pow2", "pow3"],
    "Linear",
  ),
  inInvert = op.inValueBool("Invert"),
  inBlend = op.inSwitch(
    "Blend ",
    ["Normal", "Multiply", "Opacity", "Add", "Discard"],
    "Normal",
  ),
...
const srcBodyVert =
  "".endl() +
  "#ifdef MOD_SPACE_MODEL".endl() +
  "   MOD_vertPos=vec4(vPosition,1.0);".endl() +
  "#endif".endl() +
  "#ifdef MOD_SPACE_WORLD".endl() +
  "   MOD_vertPos=mMatrix*pos;".endl() +
  "#endif".endl() +
  "#ifdef MOD_SPACE_UV".endl() +
  "   MOD_vertPos=vec4(attrTexCoord.x,attrTexCoord.y,0.0,1.0);".endl() +
  "#endif".endl();
...
function updateDefines() {
  ...
  mod.toggleDefine(
    "MOD_AREA_AXIS_X_INFINITE",
    inArea.get() == "Axis X Infinite",
  );
  mod.toggleDefine(
    "MOD_AREA_AXIS_Y_INFINITE",
    inArea.get() == "Axis Y Infinite",
  );
  mod.toggleDefine(
    "MOD_AREA_AXIS_Z_INFINITE",

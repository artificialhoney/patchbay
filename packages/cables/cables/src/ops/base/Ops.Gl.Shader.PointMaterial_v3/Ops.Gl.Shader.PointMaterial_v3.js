...
function doRender() {
  ...
  if (textureMask.get())
    shader.pushTexture(textureMaskUniform, textureMask.get().tex);
  if (textureColorize.get())
    shader.pushTexture(textureColorizeUniform, textureColorize.get().tex);
  if (textureOpacity.get())
    shader.pushTexture(textureOpacityUniform, textureOpacity.get().tex);
  if (texturePointSize.get())
    shader.pushTexture(texturePointSizeUniform, texturePointSize.get().tex);

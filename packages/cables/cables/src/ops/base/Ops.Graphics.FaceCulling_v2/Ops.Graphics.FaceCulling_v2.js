...
render.onTriggered = function () {
  ...
  if (updateFacing) {
    ...
    if (facing.get() == STR_FRONT)
      whichFace = cg.CULL_MODES[CABLES.CG.CULL_FRONT];
    else if (facing.get() == STR_BOTH)
      whichFace = cg.CULL_MODES[CABLES.CG.CULL_BOTH];
  }

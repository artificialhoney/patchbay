...
const audioOutPort = CABLES.WEBAUDIO.createAudioOutPort(
  op,
  "Audio Out",
  analyser,
);
const avgVolume = op.addOutPort(
  new CABLES.Port(op, "average volume", CABLES.OP_PORT_TYPE_VALUE),
);
const fftOut = op.addOutPort(
  new CABLES.Port(op, "fft", CABLES.OP_PORT_TYPE_ARRAY),
);

...
const srcHeadVert = "".endl() + "OUT vec4 MOD_vertPos;".endl();

const srcBodyVert =
  "".endl() +
  "#ifndef MOD_WORLDSPACE".endl() +
  "   MOD_vertPos=vec4(vPosition,1.0);".endl() +
  "#endif".endl() +
  "#ifdef MOD_WORLDSPACE".endl() +
  "   MOD_vertPos=mMatrix*pos;".endl() +
  "#endif".endl();
...
function updateDefines() {
  if (!shader) return;
  shader.toggleDefine(
    moduleVert.prefix + "BLEND_NORMAL",
    inBlend.get() == "Normal",
  );
  shader.toggleDefine(
    moduleVert.prefix + "BLEND_MULTIPLY",
    inBlend.get() != "Normal",
  );
  ...
  shader.toggleDefine(
    moduleVert.prefix + "AREA_AXIS_X",
    inArea.get() == "Axis X",
  );
  shader.toggleDefine(
    moduleVert.prefix + "AREA_AXIS_Y",
    inArea.get() == "Axis Y",
  );
  shader.toggleDefine(
    moduleVert.prefix + "AREA_AXIS_Z",
    inArea.get() == "Axis Z",
  );
  shader.toggleDefine(
    moduleVert.prefix + "AREA_AXIS_X_INFINITE",
    inArea.get() == "Axis X Infinite",
  );
  shader.toggleDefine(
    moduleVert.prefix + "AREA_AXIS_Y_INFINITE",
    inArea.get() == "Axis Y Infinite",
  );
  shader.toggleDefine(
    moduleVert.prefix + "AREA_AXIS_Z_INFINITE",
    inArea.get() == "Axis Z Infinite",
  );
  shader.toggleDefine(
    moduleVert.prefix + "AREA_SPHERE",
    inArea.get() == "Sphere",
  );
...
function doRender() {
  ...
  if (cgl.getShader() != origShader) {
    ...
    uniforms.inSizeAmountFalloffSizeX = new CGL.Uniform(
      shader,
      "4f",
      moduleFrag.prefix + "inSizeAmountFalloffSizeX",
      inSize,
      inAmount,
      inFalloff,
      sizeX,
    );
    uniforms.color = new CGL.Uniform(
      shader,
      "3f",
      moduleFrag.prefix + "color",
      r,
      g,
      b,
    );
    uniforms.pos = new CGL.Uniform(
      shader,
      "3f",
      moduleFrag.prefix + "pos",
      x,
      y,
      z,
    );

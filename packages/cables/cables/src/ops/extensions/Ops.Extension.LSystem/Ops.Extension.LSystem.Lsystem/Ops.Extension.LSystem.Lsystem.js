...
const inStrRule1 = op.inValueString(
  "Rule 1",
  "Fx5y2.2F[yxFF]fF[yXFFfzFZF]fF[yXzFFfzFZF]",
);
...
function turtle() {
  ...
  for (let i = 0; i < sentence.length; i++) {
    ...
    // turn counter clockwise x defined by angle
      ...
      else angleUi = -extract(sentence, i) * angleMultiplier;
      mat4.rotateX(
        trans,
        trans,
        CGL.DEG2RAD * (angleUi - Math.seededRandom() * inRandStr.get()),
      );
    }

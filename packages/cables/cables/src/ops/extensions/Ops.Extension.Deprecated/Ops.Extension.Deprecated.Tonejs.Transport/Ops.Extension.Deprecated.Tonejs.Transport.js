...
let bpmPort = op.addInPort(
  new CABLES.Port(this, "BPM", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
    min: 1,
    max: 300,
  }),
);
let swingPort = op.addInPort(
  new CABLES.Port(this, "Swing", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
    min: 0,
    max: 1,
  }),
...
let loopPort = op.addInPort(
  new CABLES.Port(op, "Loop", CABLES.OP_PORT_TYPE_VALUE, { display: "bool" }),
);

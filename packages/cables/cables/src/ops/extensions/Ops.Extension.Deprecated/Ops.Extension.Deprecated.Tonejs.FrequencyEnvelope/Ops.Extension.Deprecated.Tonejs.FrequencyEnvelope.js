...
let attackCurvePort = this.addInPort(
  new CABLES.Port(this, "Attack Curve", CABLES.OP_PORT_TYPE_VALUE, {
    display: "dropdown",
    values: CURVE_VALUES,
  }),
);
attackCurvePort.set(ATTACK_CURVE_DEFAULT);
let releaseCurvePort = this.addInPort(
  new CABLES.Port(this, "Release Curve", CABLES.OP_PORT_TYPE_VALUE, {
    display: "dropdown",
    values: CURVE_VALUES,
  }),
);
...
baseFrequencyPort.onChange = function () {
  setNodeValue("baseFrequency", baseFrequencyPort.get());
};
octavesPort.onChange = function () {
  setNodeValue("octaves", octavesPort.get());
};
...
attackCurvePort.onChange = function () {
  setNodeValue("attackCurve", attackCurvePort.get());
};
releaseCurvePort.onChange = function () {
  setNodeValue("releaseCurve", releaseCurvePort.get());
};

exponentPort.onChange = function () {
  setNodeValue("exponent", releasePort.get());
};

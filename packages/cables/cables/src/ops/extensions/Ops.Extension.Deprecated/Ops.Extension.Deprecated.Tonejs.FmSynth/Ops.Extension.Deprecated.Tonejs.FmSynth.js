...
let oscillatorPort = op.addInPort(
  new CABLES.Port(op, "Oscillator Type", CABLES.OP_PORT_TYPE_VALUE, {
    display: "dropdown",
...
let modulationOscillatorPort = op.addInPort(
  new CABLES.Port(op, "Modulation Oscillator Type", CABLES.OP_PORT_TYPE_VALUE, {
    display: "dropdown",
    values: OSCILLATOR_TYPES,
  }),
);

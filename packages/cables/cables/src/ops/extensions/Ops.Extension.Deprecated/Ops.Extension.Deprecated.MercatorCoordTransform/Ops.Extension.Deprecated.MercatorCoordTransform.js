...
let arr = this.addInPort(
  new CABLES.Port(this, "array", CABLES.OP_PORT_TYPE_ARRAY),
);

let centerLon = this.addInPort(
  new CABLES.Port(this, "center lon", CABLES.OP_PORT_TYPE_VALUE),
);
let centerLat = this.addInPort(
  new CABLES.Port(this, "center lat", CABLES.OP_PORT_TYPE_VALUE),
);

let mul = this.addInPort(
  new CABLES.Port(this, "mul", CABLES.OP_PORT_TYPE_VALUE),
);

let indexOut = this.addOutPort(
  new CABLES.Port(this, "index", CABLES.OP_PORT_TYPE_VALUE),
);

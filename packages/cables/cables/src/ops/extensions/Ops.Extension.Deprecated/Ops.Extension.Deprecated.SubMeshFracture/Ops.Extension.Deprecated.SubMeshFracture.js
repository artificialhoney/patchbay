...
render.onTriggered = function () {
  ...
  if (cgl.getShader() != shader) {
    ...
    inAmount.amount = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "amount",
      inAmount,
    );
    inSize.unif = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "size",
      inSize,
    );
    inFalloff.unif = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "falloff",
      inFalloff,
    );
    inScale.unif = new CGL.Uniform(
      shader,
      "f",

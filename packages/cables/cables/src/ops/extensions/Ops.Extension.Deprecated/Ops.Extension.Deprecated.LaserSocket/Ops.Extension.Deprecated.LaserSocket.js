...
this.url = this.addInPort(
  new CABLES.Port(this, "url", CABLES.OP_PORT_TYPE_VALUE, { type: "string" }),
);

let speed = this.addInPort(
  new CABLES.Port(this, "speed", CABLES.OP_PORT_TYPE_VALUE),
);
speed.set(5000);
this.result = this.addOutPort(
  new CABLES.Port(this, "result", CABLES.OP_PORT_TYPE_OBJECT),
);

...
this.r = this.addInPort(
  new CABLES.Port(this, "r", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
    colorPick: "true",
  }),
);
this.g = this.addInPort(
  new CABLES.Port(this, "g", CABLES.OP_PORT_TYPE_VALUE, { display: "range" }),
);
this.b = this.addInPort(
  new CABLES.Port(this, "b", CABLES.OP_PORT_TYPE_VALUE, { display: "range" }),
);
...
let srcFrag =
  ...
  "       col=texture2D(tex,texCoord);"
    ...
    .endl() +
  "   #endif".endl() +
  "   vec4 overCol=vec4(r,g,b,col.a);".endl() +
  "   col=mix(col,overCol, a);".endl() +

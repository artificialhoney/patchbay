const render = op.inTrigger("Render"),
  ...
  inDistribution = op.inValueSelect(
    "Distribution",
    ["Vertex", "Triangle Center", "Triangle Side"],
    "Vertex",
  ),
  ...
  if (geom.isIndexed()) {
    ...
    for (let i = 0; i < num; i++) {
      ...
      if (distMode == DISTMODE_VERTEX) {
        ...
        mat4.translate(m, m, [
          (geom.vertices[faces[index * 3] * 3 + 0] +
            geom.vertices[faces[index * 3 + 1] * 3 + 0] +
            geom.vertices[faces[index * 3 + 2] * 3 + 0]) /
            3,
          (geom.vertices[faces[index * 3] * 3 + 1] +
            geom.vertices[faces[index * 3 + 1] * 3 + 1] +
            geom.vertices[faces[index * 3 + 2] * 3 + 1]) /
            3,
          (geom.vertices[faces[index * 3] * 3 + 2] +
            geom.vertices[faces[index * 3 + 1] * 3 + 2] +
            geom.vertices[faces[index * 3 + 2] * 3 + 2]) /
            3,
        ]);
        ...
        mat4.translate(m, m, [
          (geom.vertices[faces[index * 3 + whichA] * 3 + 0] +
            geom.vertices[faces[index * 3 + whichB] * 3 + 0]) /
            2,
          (geom.vertices[faces[index * 3 + whichA] * 3 + 1] +
            geom.vertices[faces[index * 3 + whichB] * 3 + 1]) /
            2,
          (geom.vertices[faces[index * 3 + whichA] * 3 + 2] +
            geom.vertices[faces[index * 3 + whichB] * 3 + 2]) /
            2,
        ]);
      }

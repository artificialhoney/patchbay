  ...
  // if(text.get())
  {
    ...
    if (valign.get() == "center") {
      ...
      posy =
        ctx.canvas.height -
        strings.length *
          (parseFloat(fontSize.get()) + parseFloat(lineDistance.get()));

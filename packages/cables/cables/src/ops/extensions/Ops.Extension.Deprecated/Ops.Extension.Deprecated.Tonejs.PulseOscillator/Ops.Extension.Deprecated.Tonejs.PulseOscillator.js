if (Tone && Tone.context && Tone.context._context && window.audioContext) {
  op.log(
    "Checking audio context before: Tone.context._context === window.audioContext: " +
...
if (Tone && Tone.context && Tone.context._context && window.audioContext) {
  op.log(
    "Checking audio context after: Tone.context._context === window.audioContext: " +
      Tone.context._context ===
      window.audioContext,
  );
}
...
// inputs
let widthPort = CABLES.WEBAUDIO.createAudioParamInPort(
  op,
  "Width",
  node.width,
  { display: "range", min: WIDTH_MIN, max: WIDTH_MAX },
  WIDTH_DEFAULT,
);

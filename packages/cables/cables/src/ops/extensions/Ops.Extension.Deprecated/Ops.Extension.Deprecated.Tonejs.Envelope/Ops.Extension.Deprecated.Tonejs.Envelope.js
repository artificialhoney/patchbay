...
let decayPort = op.addInPort(
  new CABLES.Port(this, "Decay", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
    min: 0,
    max: 1,
  }),
);
let sustainPort = op.addInPort(
  new CABLES.Port(this, "Sustain", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
    min: 0,
    max: 1,
  }),
);
let releasePort = op.addInPort(
...
let triggerAttackPort = op.addInPort(
  new CABLES.Port(this, "Trigger Attack", CABLES.OP_PORT_TYPE_FUNCTION, {
    display: "button",
  }),
);
let velocityPort = op.addInPort(
...
let triggerReleasePort = op.addInPort(
  new CABLES.Port(this, "Trigger Release", CABLES.OP_PORT_TYPE_FUNCTION, {
    display: "button",
  }),
);

...
this.thickness = this.addInPort(
  new CABLES.Port(this, "thickness", CABLES.OP_PORT_TYPE_VALUE),
);
this.thickness.val = 1.0;

this.centerpoint = this.addInPort(
  new CABLES.Port(this, "centerpoint", CABLES.OP_PORT_TYPE_VALUE, {
    display: "bool",
  }),
);
...
this.triggerPoints = this.addOutPort(
  new CABLES.Port(this, "triggerPoints", CABLES.OP_PORT_TYPE_FUNCTION),
);

let outObj = this.addOutPort(
  new CABLES.Port(this, "json", CABLES.OP_PORT_TYPE_ARRAY),
);

let outNumPoints = this.addOutPort(
  new CABLES.Port(this, "numPoints", CABLES.OP_PORT_TYPE_VALUE),
);

let fov = this.addInPort(
  new CABLES.Port(this, "fov", CABLES.OP_PORT_TYPE_VALUE),
);
...
let coordmul = this.addInPort(
  new CABLES.Port(this, "mul", CABLES.OP_PORT_TYPE_VALUE),
);
let coordClamp = this.addInPort(
  new CABLES.Port(this, "clamp", CABLES.OP_PORT_TYPE_VALUE),
);

let colorMul = this.addInPort(
  new CABLES.Port(this, "color intensity", CABLES.OP_PORT_TYPE_VALUE),
);
colorMul.set(1.0);
let buffer = cgl.gl.createBuffer();

let hue = this.addInPort(
  new CABLES.Port(this, "hue", CABLES.OP_PORT_TYPE_VALUE),
);
colorMul.set(1.0);

let showR = this.addInPort(
  new CABLES.Port(this, "show r", CABLES.OP_PORT_TYPE_VALUE, {
    display: "bool",
  }),
);
let showG = this.addInPort(
  new CABLES.Port(this, "show g", CABLES.OP_PORT_TYPE_VALUE, {
    display: "bool",
  }),
);
let showB = this.addInPort(
  new CABLES.Port(this, "show b", CABLES.OP_PORT_TYPE_VALUE, {
    display: "bool",
  }),
);

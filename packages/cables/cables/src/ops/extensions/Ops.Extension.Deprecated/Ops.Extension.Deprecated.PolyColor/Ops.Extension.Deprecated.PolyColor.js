...
let pDefaultR = op.addInPort(
  new CABLES.Port(op, "default r", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
    colorPick: "true",
  }),
);
let pDefaultG = op.addInPort(
  new CABLES.Port(op, "default g", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
  }),
);
let pDefaultB = op.addInPort(
  new CABLES.Port(op, "default b", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
  }),
);
let pDefaultA = op.addInPort(
  new CABLES.Port(op, "default a", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
  }),
);

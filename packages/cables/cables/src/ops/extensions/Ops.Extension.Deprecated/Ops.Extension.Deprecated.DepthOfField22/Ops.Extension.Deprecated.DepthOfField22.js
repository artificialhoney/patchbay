...
this.depthTex = this.addInPort(
  new CABLES.Port(this, "depth map", CABLES.OP_PORT_TYPE_TEXTURE),
);

let tex1 = this.addInPort(
  new CABLES.Port(this, "tex", CABLES.OP_PORT_TYPE_TEXTURE),
);
let tex2 = this.addInPort(
  new CABLES.Port(this, "tex 1", CABLES.OP_PORT_TYPE_TEXTURE),
);
let tex3 = this.addInPort(
  new CABLES.Port(this, "tex 2", CABLES.OP_PORT_TYPE_TEXTURE),
);
let tex4 = this.addInPort(
  new CABLES.Port(this, "tex 3", CABLES.OP_PORT_TYPE_TEXTURE),
);

this.farPlane = this.addInPort(
  new CABLES.Port(this, "farplane", CABLES.OP_PORT_TYPE_VALUE),
);
this.nearPlane = this.addInPort(
  new CABLES.Port(this, "nearplane", CABLES.OP_PORT_TYPE_VALUE),
);

// var distNear=this.addInPort(new CABLES.Port(this,"distance near",CABLES.OP_PORT_TYPE_VALUE,{'display':'range'}));
let distFar = this.addInPort(
  new CABLES.Port(this, "distance far", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
  }),
);

let stepWidth = this.addInPort(
  new CABLES.Port(this, "step width", CABLES.OP_PORT_TYPE_VALUE, {}),
);

let showDistances = this.addInPort(
  new CABLES.Port(this, "showDistances", CABLES.OP_PORT_TYPE_VALUE, {
    display: "bool",
  }),
);
...
let srcFrag =
  "".endl() +
  "precision mediump float;".endl() +
  "IN vec2 texCoord;".endl() +
  "uniform sampler2D tex1;".endl() +
  "uniform sampler2D tex2;".endl() +
  "uniform sampler2D tex3;".endl() +
  "uniform sampler2D tex4;".endl() +
  "uniform sampler2D depthTex;".endl() +
  "uniform float f;".endl() +
  "uniform float n;".endl() +
  "uniform float stepWidth;".endl() +
  "uniform float distNear;".endl() +
  "uniform float distFar;".endl() +
  "float getDepth(vec2 tc)".endl() +
  "{".endl() +
  "    float z=texture2D(depthTex,tc).r*1.1;".endl() +
  "    float c=(2.0*n)/(f+n-z*(f-n));".endl() +
  "    return c;".endl() +
  "}".endl() +
  "void main()".endl() +
  "{".endl() +
  "   vec4 col=vec4(1.0,0.0,0.0,1.0);".endl() +
  "   col=texture2D(tex1, texCoord);".endl() +
  ...
  "   if(d>=distFar)".endl() +
  "   {".endl() +
  "       float df=distFar;".endl() +
  "       float step=(1.0-df)/stepWidth;".endl() +
  "       float blend=step/2.0;".endl() +
  "       vec4 newCol;;".endl() +
  "       if(d>=df && d<df+step)".endl() +
  "       {".endl() +
  "           newCol=texture2D(tex2, texCoord);".endl() +
  "           #ifdef SHOWAREAS".endl() +
  "newCol.r+=1.0;".endl() +
  "#endif".endl() +
  "       }".endl() +
  "       else".endl() +
  "       {".endl() +
  "           df+=step;".endl() +
  "           if(d>=df && d<df+step*1.2  )".endl() +
  "           {".endl() +
  "               col=texture2D(tex2, texCoord);".endl() +
  "               newCol=texture2D(tex3, texCoord);".endl() +
  "               #ifdef SHOWAREAS".endl() +
  "newCol.g+=1.0;".endl() +
  "#endif".endl() +
  "           }".endl() +
  ...
  "               if(d>=df)".endl() +
  "               {".endl() +
  "                   col=texture2D(tex3, texCoord);".endl() +
  "                   newCol=texture2D(tex4, texCoord);".endl() +
  "                   #ifdef SHOWAREAS".endl() +
  "newCol.b+=1.0;".endl() +
  "#endif".endl() +
  "               }".endl() +
  "           }".endl() +
  "       }".endl() +
  "       blend=1.0-min(1.0,(d-df)/blend);".endl() +
  "       col=col*blend+( (1.0-blend)*newCol);".endl() +
  "   }".endl() +
  "   col.a=1.0;".endl() +
...
showDistances.onValueChange(function () {
...
distFar.onValueChange(function () {
  uniDistFar.setValue(distFar.get());
});
stepWidth.onValueChange(function () {
  uniStepWidth.setValue(stepWidth.get());
});
// distNear.set(0.2);
distFar.set(0.5);
stepWidth.set(10);

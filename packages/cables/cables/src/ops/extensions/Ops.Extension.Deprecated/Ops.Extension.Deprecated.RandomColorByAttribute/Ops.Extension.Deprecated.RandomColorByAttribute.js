...
function updateCode() {
  ...
  srcHeadFrag =
    "".endl() +
    "UNI float MOD_seed;".endl() +
    "UNI float MOD_min;".endl() +
    "UNI float MOD_max;".endl() +
    "UNI float MOD_randR;".endl() +
    "UNI float MOD_randG;".endl() +
    "UNI float MOD_randB;".endl() +
    "float MOD_round(float user_a) {".endl() +
    "   return floor((user_a+0.5));".endl() +
    "}".endl() +
    "float MOD_rand(vec2 co){".endl() +
    "    return fract(sin(dot(co.xy ,vec2(12.9,78.2))) * 43758.3);".endl() +
    "}".endl();

  srcBodyFrag =
    "".endl() +
    "float MOD_coord=MOD_round(" +
    attrName +
    "Frag*1000.0)/1000.0+MOD_seed;".endl() +
    "col.rgb*= (MOD_rand(vec2(MOD_coord))*(MOD_max-MOD_min))+MOD_min ;".endl() +
    "col.r+=MOD_rand(vec2(MOD_coord*2.0))*MOD_randR;".endl() +
    "col.g+=MOD_rand(vec2(MOD_coord*3.0))*MOD_randG;".endl() +
    "col.b+=MOD_rand(vec2(MOD_coord*13.0))*MOD_randB;".endl();
...
render.onTriggered = function () {
  ...
  if (cgl.getShader() != shader || needsCodeUpdate || !srcBodyFrag) {
    ...
    inSeed.uni = new CGL.Uniform(
      shader,
      "f",
      moduleFrag.prefix + "seed",
      inSeed,
    );
    ...
    inRandR.uni = new CGL.Uniform(
      shader,
      "f",
      moduleFrag.prefix + "randR",
      inRandR,
    );
    inRandG.uni = new CGL.Uniform(
      shader,
      "f",
      moduleFrag.prefix + "randG",
      inRandG,
    );
    inRandB.uni = new CGL.Uniform(
      shader,
      "f",
      moduleFrag.prefix + "randB",
      inRandB,
    );
  }

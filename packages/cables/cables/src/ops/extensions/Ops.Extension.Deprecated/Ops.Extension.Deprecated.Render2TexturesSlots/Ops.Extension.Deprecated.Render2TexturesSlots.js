...
render.onTriggered = function () {
  ...
  if (currentShader != shader || needsReset) {
    ...
    uniBool1 = new CGL.Uniform(
      shader,
      "b",
      moduleFrag.prefix + "tex0",
      ports[0],
    );
    uniBool2 = new CGL.Uniform(
      shader,
      "b",
      moduleFrag.prefix + "tex1",
      ports[1],
    );
    uniBool3 = new CGL.Uniform(
      shader,
      "b",
      moduleFrag.prefix + "tex2",
      ports[2],
    );
    uniBool4 = new CGL.Uniform(
      shader,
      "b",
      moduleFrag.prefix + "tex3",
      ports[3],
    );

...
let modulationIndexPort = op.inValue(
  "Modulation Index",
  node.get("modulationIndex").modulationIndex,
);
let harmonicityPort = op.inValue(
  "Harmonicity",
  node.get("harmonicity").harmonicity,
);

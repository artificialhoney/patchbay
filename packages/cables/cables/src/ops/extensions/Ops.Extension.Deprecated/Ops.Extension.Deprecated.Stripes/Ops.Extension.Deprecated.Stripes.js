...
let width = op.addInPort(
  new CABLES.Port(op, "width", CABLES.OP_PORT_TYPE_VALUE, { display: "range" }),
);
let axis = op.addInPort(
  new CABLES.Port(op, "axis", CABLES.OP_PORT_TYPE_VALUE, {
    display: "dropdown",
    values: ["X", "Y", "Diagonal", "Diagonal Flip"],
  }),
);

let offset = op.addInPort(
  new CABLES.Port(op, "offset", CABLES.OP_PORT_TYPE_VALUE),
);
...
let g = op.addInPort(
  new CABLES.Port(op, "g", CABLES.OP_PORT_TYPE_VALUE, { display: "range" }),
);
let b = op.addInPort(
  new CABLES.Port(op, "b", CABLES.OP_PORT_TYPE_VALUE, { display: "range" }),
);
let a = op.addInPort(
  new CABLES.Port(op, "a", CABLES.OP_PORT_TYPE_VALUE, { display: "range" }),
);

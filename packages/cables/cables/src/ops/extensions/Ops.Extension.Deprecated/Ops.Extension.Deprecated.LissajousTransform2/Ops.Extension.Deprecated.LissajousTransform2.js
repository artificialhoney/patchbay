...
let pointSkip = op.addInPort(
  new CABLES.Port(op, "skip", CABLES.OP_PORT_TYPE_VALUE),
);
let numPoints = op.addInPort(
  new CABLES.Port(op, "num points", CABLES.OP_PORT_TYPE_VALUE),
);

let mulX = op.addInPort(
  new CABLES.Port(op, "mul x", CABLES.OP_PORT_TYPE_VALUE),
);
let mulY = op.addInPort(
  new CABLES.Port(op, "mul y", CABLES.OP_PORT_TYPE_VALUE),
);
let mulZ = op.addInPort(
  new CABLES.Port(op, "mul z", CABLES.OP_PORT_TYPE_VALUE),
);

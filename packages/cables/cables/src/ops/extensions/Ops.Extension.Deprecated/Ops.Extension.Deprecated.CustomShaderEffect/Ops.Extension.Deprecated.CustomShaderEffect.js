...
const fragHead = op.addInPort(
  new CABLES.Port(op, "Fragment Head", CABLES.OP_PORT_TYPE_VALUE, {
    display: "editor",
    editorSyntax: "glsl",
  }),
);
const fragBody = op.addInPort(
  new CABLES.Port(op, "Fragment Main", CABLES.OP_PORT_TYPE_VALUE, {
    display: "editor",
    editorSyntax: "glsl",
  }),
);
...
function updateShader() {
  ...
  let activeUniforms = cgl.gl.getProgramParameter(
    shader.getProgram(),

...
const srcHeadVert =
  "".endl() +
  "#ifndef ATTRIB_instanceIndex".endl() +
  "  #define ATTRIB_instanceIndex".endl() +
  "  IN float instanceIndex;".endl() +
  "#endif".endl() +
  "#ifdef MOD_COLORIZE".endl() +
  "   OUT vec4 MOD_color;".endl() +
  "#endif".endl();

const srcHeadFrag =
  "".endl() +
  "#ifdef MOD_COLORIZE".endl() +
  "   IN vec4 MOD_color;".endl() +
  "#endif".endl();

const srcBodyFrag =
  "".endl() +
  "#ifdef MOD_COLORIZE".endl() +
  "   col*=MOD_color*MOD_colorMul;".endl() +
  "#endif".endl();

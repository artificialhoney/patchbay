...
let amount = op.addInPort(
  new CABLES.Port(op, "amount", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
  }),
);
let posy = op.addInPort(
  new CABLES.Port(op, "pos", CABLES.OP_PORT_TYPE_VALUE, { display: "range" }),
);
let image = op.addInPort(
...
let srcFrag =
  ...
  "   vec4 colOrig=texture2D(tex,texCoord);".endl() +
  "#ifdef VERT".endl() +
  "   col.r=texture2D(image,vec2(colOrig.r,pos)).r;".endl() +
  "   col.g=texture2D(image,vec2(colOrig.g,pos)).g;".endl() +
  "   col.b=texture2D(image,vec2(colOrig.b,pos)).b;".endl() +
  "#endif".endl() +
  "#ifdef HORI".endl() +
  "   col.r=texture2D(image,vec2(pos,colOrig.r)).r;".endl() +
  "   col.g=texture2D(image,vec2(pos,colOrig.g)).g;".endl() +
  "   col.b=texture2D(image,vec2(pos,colOrig.b)).b;".endl() +
  "#endif".endl() +
  "   col.a=1.0;".endl() +

...
let clear = op.addInPort(
  new CABLES.Port(op, "clear depth", CABLES.OP_PORT_TYPE_VALUE, {
    display: "bool",
  }),
);
let enable = op.addInPort(
  new CABLES.Port(op, "enable depth testing", CABLES.OP_PORT_TYPE_VALUE, {
    display: "bool",
  }),
);
let write = op.addInPort(
  new CABLES.Port(op, "write to depth buffer", CABLES.OP_PORT_TYPE_VALUE, {
    display: "bool",
  }),
);

let depthFunc = op.addInPort(

...
let orderPort = op.addInPort(
  new CABLES.Port(op, "Order", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
    min: ORDER_MIN,
    max: ORDER_MAX,
  }),
...
let oversamplePort = this.addInPort(
  new CABLES.Port(this, "align", CABLES.OP_PORT_TYPE_VALUE, {
    display: "dropdown",

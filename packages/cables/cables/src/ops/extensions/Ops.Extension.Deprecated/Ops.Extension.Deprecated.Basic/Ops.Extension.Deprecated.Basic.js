...
// Input ports
let execute = op.addInPort(
  new CABLES.Port(this, "Execute", CABLES.OP_PORT_TYPE_FUNCTION),
);
let number1 = op.addInPort(
  new CABLES.Port(op, "Number 1", CABLES.OP_PORT_TYPE_),
);
let number2 = op.addInPort(
  new CABLES.Port(op, "Number 2", CABLES.OP_PORT_TYPE_),
);
// Output ports

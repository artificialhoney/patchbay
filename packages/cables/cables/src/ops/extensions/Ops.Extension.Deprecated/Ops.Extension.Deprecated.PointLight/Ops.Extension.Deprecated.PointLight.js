...
let attachment = op.addOutPort(
  new CABLES.Port(op, "attachment", CABLES.OP_PORT_TYPE_FUNCTION),
);
let attenuation = op.addInPort(
  new CABLES.Port(op, "attenuation", CABLES.OP_PORT_TYPE_VALUE),
);
...
let mul = op.addInPort(
  new CABLES.Port(op, "multiply", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
  }),
);

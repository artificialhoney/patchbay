...
let distortionPort = op.addInPort(
  new CABLES.Port(op, "Distortion", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
    min: DISTORTION_MIN,
    max: DISTORTION_MAX,
  }),
...
let oversamplePort = op.addInPort(
  new CABLES.Port(op, "Oversample", CABLES.OP_PORT_TYPE_VALUE, {
    display: "dropdown",
    values: OVERSAMPLE_VALUES,
  }),
);

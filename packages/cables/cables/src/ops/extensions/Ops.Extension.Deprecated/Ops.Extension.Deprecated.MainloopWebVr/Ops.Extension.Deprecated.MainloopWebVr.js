...
function removeButton() {
  if (buttonEle && buttonEle.parentNode)
...
function initButton() {
  ...
  buttonEle.style["background-image"] =
    "url(data:image/svg+xml," + attachments.icon_svg + ")";
}
...
function renderEye(which) {
  ...
  if (!started) {
    ...
    cgl.setViewPort(0, 0, cgl.canvasWidth * 0.5, cgl.canvasHeight);
    ...
    for (let i = 0; i < displays.length; i++) {
      ...
      op.log(
        "Display " +
          ...
          "\n" +
          "Display can present content: " +
          cap.canPresent +
          "\n" +
          "Display is separate from the computer's main display: " +
          cap.hasExternalDisplay +
          "\n" +
          "Display can return position info: " +
          cap.hasPosition +
          "\n" +
          "Display can return orientation info: " +
          cap.hasOrientation +
          "\n" +
          "Display max layers: " +
          cap.maxLayers,

...
// input ports
let audioInPort1 = CABLES.WEBAUDIO.createAudioInPort(
  op,
  "Audio In 1",
  node.input[0],
);
let audioInPort2 = CABLES.WEBAUDIO.createAudioInPort(
  op,
  "Audio In 2",
  node.input[1],
);
let fadePort = CABLES.WEBAUDIO.createAudioParamInPort(
  op,
  "Fade",
  node.fade,
  { display: "range", min: FADE_MIN, max: FADE_MAX },
  FADE_DEFAULT,
);

...
op.render.onTriggered = function () {
  ...
  if (cgl.getShader() != shader) {
    ...
    op.uniRotX = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "rotX",
      inRotX,
    );
    op.uniRotY = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "rotY",
      inRotY,
    );
    op.uniRotZ = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "rotZ",
      inRotZ,
    );

    op.uniposX = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "posX",
      inPosX,
    );
    op.uniposY = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "posY",
      inPosY,
    );
    op.uniposZ = new CGL.Uniform(
      shader,
      "f",
    ...
    op.uniscaleX = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "scaleX",
      inScaleX,
    );
    op.uniscaleY = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "scaleY",
      inScaleY,
    );
    op.uniscaleZ = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "scaleZ",
      inScaleZ,
    );

    op.uniStart = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "start",
      inStart,
    );
    op.uniEnd = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "width",
      inWidth,
    );
    op.uniTrans = new CGL.Uniform(
      shader,
      "f",
      moduleVert.prefix + "transDist",
      inTransDist,
    );

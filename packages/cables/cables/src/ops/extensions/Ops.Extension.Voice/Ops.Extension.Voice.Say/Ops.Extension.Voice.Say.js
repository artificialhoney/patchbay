...
let voicePort = op.addInPort(
  new CABLES.Port(op, "Voice", CABLES.OP_PORT_TYPE_VALUE, {
    display: "dropdown",
    values: voiceMapKeys,
  }),
);
let pitchPort = op.addInPort(
  new CABLES.Port(op, "Pitch", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
    min: PITCH_MIN,
    max: PITCH_MAX,
  }),
...
let ratePort = op.addInPort(
  new CABLES.Port(op, "Rate", CABLES.OP_PORT_TYPE_VALUE, {
    display: "range",
    min: RATE_MIN,
    max: RATE_MAX,
  }),

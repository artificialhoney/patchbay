...
inTrigger.onTriggered = () => {
  ...
  if (!shader) {
    ...
    shader.addUniform(
      new CGP.Uniform(shader, "4f", "color", r, g, b, a),
    ...
    shader.addUniform(
      new CGP.Uniform(shader, "t", "ourTexture", inTex),
      GPUShaderStage.FRAGMENT,
    );

    shader.addUniform(
      new CGP.Uniform(shader, "t", "texDiffuse", inTextureDiffuse),
      GPUShaderStage.FRAGMENT,
    );

    shader.addUniform(
      new CGP.Uniform(shader, "sampler", "ourSampler", inTextureDiffuse),
      GPUShaderStage.FRAGMENT,
    );
  }

...
const port_502whkmy4 = op.inString(
  "502whkmy4",
  "/assets/6230d3a5e65df56b95088672/roboto-v29-latin-regular.ttf",
);
...
op.initInnerPorts = function (addedOps) {
  for (let i = 0; i < addedOps.length; i++) {
    if (addedOps[i].innerInput) {
      ...
      port_o44faoari.onTriggered = () => {
        innerOut_o44faoari.trigger();
      };
      ...
      port_502whkmy4.on("change", (a, v) => {
        innerOut_502whkmy4.set(a);
      });
    }

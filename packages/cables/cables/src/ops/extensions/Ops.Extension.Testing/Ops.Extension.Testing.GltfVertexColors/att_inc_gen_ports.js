...
const port_jgob8i89i = op.inString(
  "jgob8i89i",
  "/assets/619e244ce4dff21e0ce04166/vertexpaint_cube.glb",
);
...
op.initInnerPorts = function (addedOps) {
  for (let i = 0; i < addedOps.length; i++) {
    if (addedOps[i].innerInput) {
      ...
      port_94uzkbsko.onTriggered = () => {
        innerOut_94uzkbsko.trigger();
      };
      ...
      port_jgob8i89i.on("change", (a, v) => {
        innerOut_jgob8i89i.set(a);
      });
    }

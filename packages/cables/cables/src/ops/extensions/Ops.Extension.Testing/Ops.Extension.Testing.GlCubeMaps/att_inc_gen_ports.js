...
const port_6jxk2lid3 = op.inString(
  "6jxk2lid3",
  "/assets/67bed8fd280089832fce1e2e/px__1_.webp",
);
port_6jxk2lid3.setUiAttribs({ title: "posx", display: "file" });

const port_4fcnn9spy = op.inString(
  "4fcnn9spy",
  "/assets/67bed8fd280089832fce1e2e/nx__1_.webp",
);
port_4fcnn9spy.setUiAttribs({ title: "negx", display: "file" });

const port_wv5o1z0mp = op.inString(
  "wv5o1z0mp",
  "/assets/67bed8fd280089832fce1e2e/py__1_.webp",
);
port_wv5o1z0mp.setUiAttribs({ title: "posy", display: "file" });

const port_hpe4kbj74 = op.inString(
  "hpe4kbj74",
  "/assets/67bed8fd280089832fce1e2e/ny__1_.webp",
);
port_hpe4kbj74.setUiAttribs({ title: "negy", display: "file" });

const port_ozkx149s6 = op.inString(
  "ozkx149s6",
  "/assets/67bed8fd280089832fce1e2e/pz__1_.webp",
);
port_ozkx149s6.setUiAttribs({ title: "posz", display: "file" });

const port_xwfw3og4z = op.inString(
  "xwfw3og4z",
  "/assets/67bed8fd280089832fce1e2e/nz__1_.webp",
);
...
op.initInnerPorts = function (addedOps) {
  for (let i = 0; i < addedOps.length; i++) {
    if (addedOps[i].innerInput) {
      ...
      port_24wczq4w3.onTriggered = () => {
        innerOut_24wczq4w3.trigger();
      };
      ...
      port_6jxk2lid3.on("change", (a, v) => {
        innerOut_6jxk2lid3.set(a);
      });
      ...
      port_4fcnn9spy.on("change", (a, v) => {
        innerOut_4fcnn9spy.set(a);
      });
      ...
      port_wv5o1z0mp.on("change", (a, v) => {
        innerOut_wv5o1z0mp.set(a);
      });
      ...
      port_hpe4kbj74.on("change", (a, v) => {
        innerOut_hpe4kbj74.set(a);
      });
      ...
      port_ozkx149s6.on("change", (a, v) => {
        innerOut_ozkx149s6.set(a);
      });
      ...
      port_xwfw3og4z.on("change", (a, v) => {
        innerOut_xwfw3og4z.set(a);
      });
    }

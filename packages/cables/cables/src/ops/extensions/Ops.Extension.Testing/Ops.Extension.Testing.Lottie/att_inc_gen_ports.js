...
const port_317uc3lxl = op.inString(
  "317uc3lxl",
  "/assets/664711fbbb71706c00625ead/lottie.json",
);
...
op.initInnerPorts = function (addedOps) {
  for (let i = 0; i < addedOps.length; i++) {
    if (addedOps[i].innerInput) {
      ...
      port_nwshu8bql.onTriggered = () => {
        innerOut_nwshu8bql.trigger();
      };
      ...
      port_317uc3lxl.on("change", (a, v) => {
        innerOut_317uc3lxl.set(a);
      });
    }

...
const port_3cusibym6 = op.inString(
  "3cusibym6",
  "/assets/67bed8fd280089832fce1e2e/RgbRampsDiagonal.exr",
);
...
op.initInnerPorts = function (addedOps) {
  for (let i = 0; i < addedOps.length; i++) {
    if (addedOps[i].innerInput) {
      ...
      port_9ruhsdsh9.onTriggered = () => {
        innerOut_9ruhsdsh9.trigger();
      };
      ...
      port_3cusibym6.on("change", (a, v) => {
        innerOut_3cusibym6.set(a);
      });
    }

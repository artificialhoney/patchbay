...
const port_kum9etdeb = op.inString(
  "kum9etdeb",
  "/assets/615acb0995a0966eb0937a6f/head-multi_UV.glb",
);
...
op.initInnerPorts = function (addedOps) {
  for (let i = 0; i < addedOps.length; i++) {
    if (addedOps[i].innerInput) {
      ...
      port_3ag0l5i42.onTriggered = () => {
        innerOut_3ag0l5i42.trigger();
      };
      ...
      port_kum9etdeb.on("change", (a, v) => {
        innerOut_kum9etdeb.set(a);
      });
    }

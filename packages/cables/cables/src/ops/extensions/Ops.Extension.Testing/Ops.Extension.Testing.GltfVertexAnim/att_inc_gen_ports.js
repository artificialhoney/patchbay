...
const port_zmd1pqgqt = op.inString(
  "zmd1pqgqt",
  "/assets/67bed8fd280089832fce1e2e/pointanim.glb",
);
...
op.initInnerPorts = function (addedOps) {
  for (let i = 0; i < addedOps.length; i++) {
    if (addedOps[i].innerInput) {
      ...
      port_fwagmglix.onTriggered = () => {
        innerOut_fwagmglix.trigger();
      };
      ...
      port_zmd1pqgqt.on("change", (a, v) => {
        innerOut_zmd1pqgqt.set(a);
      });
    }

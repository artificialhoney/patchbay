...
const port_q7rod63s1 = op.inString(
  "q7rod63s1",
  "/assets/664711fbbb71706c00625ead/cables.svg",
);
...
op.initInnerPorts = function (addedOps) {
  for (let i = 0; i < addedOps.length; i++) {
    if (addedOps[i].innerInput) {
      ...
      port_m57hn1hvy.onTriggered = () => {
        innerOut_m57hn1hvy.trigger();
      };
      ...
      port_q7rod63s1.on("change", (a, v) => {
        innerOut_q7rod63s1.set(a);
      });
    }

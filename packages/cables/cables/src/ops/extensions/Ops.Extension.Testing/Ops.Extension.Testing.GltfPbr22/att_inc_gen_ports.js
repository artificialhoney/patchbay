...
const port_sctq1r681 = op.inString(
  "sctq1r681",
  "/assets/654a1089765b6f277db8e991/DamagedHelmet.glb",
);
port_sctq1r681.setUiAttribs({ title: "glb File", display: "file" });

const port_s8gc9utlu = op.inString(
  "s8gc9utlu",
  "/assets/664711fbbb71706c00625ead/helm_albedo.webp",
);
port_s8gc9utlu.setUiAttribs({ title: "File", display: "file" });

const port_1q0owu3w6 = op.inString(
  "1q0owu3w6",
  "/assets/664711fbbb71706c00625ead/helm_aorm.webp",
);
port_1q0owu3w6.setUiAttribs({ title: "File", display: "file" });

const port_hs0fvs2ks = op.inString(
  "hs0fvs2ks",
  "/assets/664711fbbb71706c00625ead/helm_normal.webp",
);
...
op.initInnerPorts = function (addedOps) {
  for (let i = 0; i < addedOps.length; i++) {
    if (addedOps[i].innerInput) {
      ...
      port_si0ni96ke.onTriggered = () => {
        innerOut_si0ni96ke.trigger();
      };
      ...
      port_sctq1r681.on("change", (a, v) => {
        innerOut_sctq1r681.set(a);
      });
      ...
      port_s8gc9utlu.on("change", (a, v) => {
        innerOut_s8gc9utlu.set(a);
      });
      ...
      port_1q0owu3w6.on("change", (a, v) => {
        innerOut_1q0owu3w6.set(a);
      });
      ...
      port_hs0fvs2ks.on("change", (a, v) => {
        innerOut_hs0fvs2ks.set(a);
      });
    }

...
function updateDefines() {
  ...
  if (!inAbsVel.isLinked() && inMethod.get() == "Collision")
    op.setUiError("absvelneeded", "need to connect abs velocity");

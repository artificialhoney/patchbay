const render = op.inTrigger("Render"),
  ...
  inMethod = op.inValueSelect(
    "Method",
    ["Point", "Direction", "Collision", "Rotate", "Vortex"],
    "Point",
  ),
...
function updateDefines() {
  ...
  dir_x.setUiAttribs({
    greyout: inMethod.get() != "Direction" && inMethod.get() != "Rotate",
  });
  dir_y.setUiAttribs({
    greyout: inMethod.get() != "Direction" && inMethod.get() != "Rotate",
  });
...
render.onTriggered = function () {
  ...
  velAreaSys.bgShader.pushTexture(
    texTiming,
    cgl.frameStore.particleSys.texTimingInt || CGL.Texture.getEmptyTexture(cgl),
  );
